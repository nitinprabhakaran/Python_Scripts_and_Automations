...
list_add_button = tkinter.Button(input_frame, text="Add Item", borderwidth=2,
...
my_listbox = tkinter.Listbox(output_frame, height=15, width=45, borderwidth=3,
...
#Button Frame layout
list_remove_button = tkinter.Button(button_frame, text="Remove Item", borderwidth=2,
font=my_font, bg=button_color, command=remove_item)
list_clear_button = tkinter.Button(button_frame, text='Clear List', borderwidth=2,
font=my_font, bg=button_color, command=clear_list)
save_button = tkinter.Button(button_frame, text='Save List', borderwidth=2,
