...
def search():
    ...
    '''{'coord': {'lon': -71.06, 'lat': 42.36}, 'weather': [{'id': 500, 'main': 'Rain','description': 'light rain', 'icon': '10d'}], 'base': 'stations', 44 'main': {'temp': 298.88, 'feels_like': 302.56, 'temp_min': 298.15, 'temp_max': 299.82, 'pressure': 1010, 'humidity': 85}, 'visibility': 10000, 45 'wind': {'speed': 2.24, 'deg': 151, 'gust': 4.47}, 'rain': {'1h': 0.25}, 'clouds': {'all': 82}, 'dt': 1596407271, 'sys': {'type': 3, 'id': 2005683, 46 'country': 'US', 'sunrise': 1596361095, 'sunset': 1596412955}, 'timezone': -14400, 'id': 4930956, 'name': 'Boston', 'cod': 200}'''
...
def get_weather():
    ...
    city_info_label.config(text=city_name + "(" + city_lat + ", " + city_lon + ")", t=large_font, bg=output_color)
...
submit_button = tkinter.Button(input_frame, text='Submit', font=large_font,
